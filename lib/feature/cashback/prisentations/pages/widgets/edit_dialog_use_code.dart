...
class EditDialogUseCode extends GetView<EditCashbackController> {
  const EditDialogUseCode({
    super.key,
  });
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    RadioListTile<UseCodeManyTime?>(
                      ...
                      value: controller.useCodeManyTime.value,
                      title: const CustomText(
                      ...
                      groupValue: UseCodeManyTime.onlyOne,
                    ),
                    20.sh,
                    ...
                    RadioListTile<UseCodeManyTime?>(
                      ...
                      onChanged: (UseCodeManyTime? value) =>
                          controller.onChangeUseCodeManyTime(value!),
                      groupValue: UseCodeManyTime.moreThanOne,
                    ),
                    20.sh,
